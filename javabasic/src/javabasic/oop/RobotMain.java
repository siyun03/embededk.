...
public class RobotMain {
	...
	public static void main(String[] args) {
		...
		creatRobot(robotFactory, "태권브이", "태권브이주식회사", 
				new Timestamp(System.currentTimeMillis()), 100);
		
		creatRobot(robotFactory, "건담", "건담주식회사", 
				new Timestamp(System.currentTimeMillis()), 150);
		
		creatRobot(robotFactory, "또봇", "또봇주식회사", 
				new Timestamp(System.currentTimeMillis()), 50);
		
	} // main

	private static void creatRobot(RobotFactory robotFactory,
